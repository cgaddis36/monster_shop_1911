...
RSpec.describe 'Cart creation' do
  describe 'When I visit an items show page' do
    ...
    before(:each) do
      ...
      @pencil = @mike.items.create(name: "Yellow Pencil", description: "You can write on paper with it!", price: 2, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 1)
    end
